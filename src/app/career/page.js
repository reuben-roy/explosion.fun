...
export default function Career() {
    ...
    const certifications = [
        ...
        },
        {
            ...
            features: [{"title": "Technology Stack", "items": ["Anthropic", "FullCalendar", "Go", "LLMs", "Lucide", "Next.js", "OpenAI", "RAG", "React", "Tailwind CSS"]}],
            urls: [{"name": "Blistering Barnacles Live \u2197", "url": "https://blistering-barnacles.vercel.app"}, {"name": "GitHub Repository", "url": "https://github.com/reuben-roy/blistering-barnacles"}]
        },
        {
            title: "Kali",
            overview: [
            ...
            urls: [{"name": "Kali Live \u2197", "url": "https://kali-rose.vercel.app"}, {"name": "GitHub Repository", "url": "https://github.com/reuben-roy/Kali"}]
        },
        {
            title: "Kali Platform",
            overview: [
                "The mobile engine for Kali — a React Native fitness app that treats physical progression like a tech tree, with muscle-specific fatigue tracking and local-first data."
            ],
            features: [{"title": "Technology Stack", "items": ["Go", "Lucide", "REST", "React", "React Native", "SQL", "SQLite", "Tailwind CSS", "TypeScript"]}],
            urls: [{"name": "GitHub Repository", "url": "https://github.com/reuben-roy/Kali-Platform"}]
        },
        {
            title: "Ranker",
            overview: [
            ...
            features: [{"title": "Technology Stack", "items": ["Go", "Lucide", "OAuth", "PostgreSQL", "RAG", "REST", "React", "React Native", "SQL", "Tailwind CSS"]}],
        ...
        },
        {
            ...
            urls: [{"name": "Side Track Live \u2197", "url": "https://apps.apple.com/app/side-track/id6755348971"}, {"name": "GitHub Repository", "url": "https://github.com/reuben-roy/Side-Track"}]
        },
        {
            title: "Switch Market",
            overview: [
        ...
        },
        {
            ...
            features: [{"title": "Technology Stack", "items": ["Fastify", "FullCalendar", "Go", "Node.js", "OAuth", "PostgreSQL", "Prisma", "RAG", "REST", "React"]}],
