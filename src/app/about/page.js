  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <p style={{ color: '#000', textAlign: 'center', maxWidth: 700, margin: '0 auto 2rem' }}>
        ...
        <section style={{ background: 'rgba(0,255,255,0.05)', borderRadius: 12, padding: '1.5rem', maxWidth: 600, margin: '0 auto', color: '#000', boxShadow: '0 2px 12px rgba(0,0,0,0.1)' }}>
